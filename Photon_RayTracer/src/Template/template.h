...
static const char* TemplateVersion = "RayTracer_RinkWilbrink_210029"; // Template_v2021.09
...
#pragma warning (pop)
    ...
    float sqrLenght() { return x * x + y * y; }
...
#pragma warning (pop)
    vec3() { x = 0.0f; y = 0.0f; z = 0.0f; dummy = 0.0f; }
    ...
    float sqrLenght() const { return x * x + y * y + z * z; }
    ...
    { return vec3(1, 1, 1); }
    inline static vec3 NOne()
    { return Tmpl8::vec3(-1, -1, -1); }
...
#pragma warning (pop)
    ...
    float sqrLenght() { return x * x + y * y + z * z + w * w; }
