...
{
	/* This is bad code, since it goes over EVERY pixel, which costs a lot of time.
	...
	*/
	...
	// This just sets all values in the array to the desired colour.
	memset(m_Buffer, (int)a_Color, m_Width * m_Height * 4);
}
