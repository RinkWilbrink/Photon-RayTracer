...
typedef enum
{
    ...
    KEYCODE_INTERNATIONAL1 = 135, /**< used on Asian keyboards, see footnotes in USB doc */
    ...
    KEYCODE_RGUI = 231, /**< windows, command (apple), meta */
     ...
     KEYCODE_NUM_SCANCODES, // this is the current amount of keys in the 
     KEYCODE_MAX_NUM_SCANCODES = 512 /**< not a key, just marks the number of scancodes // This is the max amount of keys possible
                                                                                                                                                                                                                                                                                                                                  for array bounds */
} KeyboardKeys;